        ...
        <div className="border-t border-white/10 p-3">
          <div className="flex gap-2">
            <input
              ...
              className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white outline-none transition-colors placeholder:text-gray-500 focus:border-accent"
