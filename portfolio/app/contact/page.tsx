          ...
          <div>
            ...
            <Reveal delay={80}>
              <div className="glass-card p-8">
                ...
                <div className="mt-8 rounded-2xl border border-border-glass bg-surface-2 p-5">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-3 inline-block text-sm text-accent-light transition-colors hover:text-foreground"
                  >
                    Open in Google Maps →
                  </a>
                </div>
